...
win.border(0)
win.nodelay(1) #1 stands for true means its not using user response 

#snake and food
snake = [(4,10),(4,9), (4,8)] #tuple = immutable 4,10 head 4,8 tail
food = (10,20) ##
...
while key !=ESC: #runs endlessly 
 ...
 #│IndexError: list index out of range providing an index for which a list element does not exist.
